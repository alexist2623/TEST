...
HD_PWD='C:/M-labs/TEST/RTIO_DEVELOPMENT/RTIO_DEVELOPMENT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rti_core.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rti_core.tcl -notrace
