...
HD_PWD='C:/M-labs/RTIO_DEVELOPMENT/RTIO_DEVELOPMENT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_dualclk.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fifo_dualclk.tcl -notrace
